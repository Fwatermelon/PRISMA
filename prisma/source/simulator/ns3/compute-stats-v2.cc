...
float ComputeStats::getSignalingOverhead(){
    ...
    // NS_LOG_UNCOND("Signaling overhead = " << float(m_globalBytesSignaling)/float(m_globalBytesData) << " globalBytesData = " << m_globalBytesData << " globalBytesSignaling = " << m_globalBytesSignaling);
