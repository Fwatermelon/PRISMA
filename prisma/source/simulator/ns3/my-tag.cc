...
bool MyTag::GetIsFirst (void) const
{
  return m_isFirst;
}
void MyTag::SetIsFirst (bool value)
{
  m_isFirst = value;
}
void
...
void
MyTag::SetSourceOverlay (uint32_t value)
{
  m_sourceOverlay = value;
}
uint32_t
MyTag::GetSourceOverlay (void) const
{
